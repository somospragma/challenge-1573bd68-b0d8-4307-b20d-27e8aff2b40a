...
package com.pragma.payment.adapter.inbound;
...
// === ARCHIVO: src/main/java/com/pragma/payment/application/PaymentService.java ===
...
// === ARCHIVO: src/main/java/com/pragma/payment/domain/PaymentEvent.java ===
...
spring:
  ...
  resilience4j:
    circuitbreaker:
      ...
      instances:
        paymentEvent:
          baseConfig: paymentEventCircuitBreaker
    retry:
      configs:
        paymentEventRetry:
          maxAttempts: 3
      ...
      instances:
        paymentEvent:
          config: paymentEventRetry
    bulkhead:
      configs:
        paymentEventBulkhead:
          maxConcurrentCalls: 10
          waitDurationInQueue: PT1S
      instances:
        paymentEvent:
          config: paymentEventBulkhead

// === ARCHIVO: src/test/java/com/pragma/payment/PaymentServiceTest.java ===
